...
class __TwigTemplate_19f460664ed6c80d8f2924245ad41fd26b30d51179d1d7e9e65ea8cf645ea5d9 extends Craft\BaseTemplate
{
...
";
        ...
        echo $_forms_->gettextField(array("label" => \Craft\Craft::t("Access Key ID"), "id" => "keyId", "name" => "keyId", "value" => $this->getAttribute($_settings_, "keyId"), "errors" => $this->getAttribute($_settings_, "getErrors", array(0 => "keyId"), "method"), "class" => "s3-key-id", "required" => true));
        // line 13
        echo "
...
";
        ...
        if (isset($context["forms"])) { $_forms_ = $context["forms"]; } else { $_forms_ = null; }
        if (isset($context["settings"])) { $_settings_ = $context["settings"]; } else { $_settings_ = null; }
        echo $_forms_->gettextField(array("label" => \Craft\Craft::t("Secret Access Key"), "id" => "secret", "name" => "secret", "value" => $this->getAttribute($_settings_, "secret"), "errors" => $this->getAttribute($_settings_, "getErrors", array(0 => "secret"), "method"), "class" => "s3-secret-key", "required" => true));
        // line 23
        echo "
...
\t\t\t\t";
        ...
        if (isset($context["forms"])) { $_forms_ = $context["forms"]; } else { $_forms_ = null; }
        if (isset($context["settings"])) { $_settings_ = $context["settings"]; } else { $_settings_ = null; }
        echo $_forms_->getselect(array("id" => "bucket", "name" => "bucket", "options" => array($this->getAttribute($_settings_, "bucket") => $this->getAttribute($_settings_, "bucket")), "value" => $this->getAttribute($_settings_, "bucket"), "disabled" => true, "class" => "s3-bucket-select"));
        // line 36
        echo "
\t\t\t</td>
\t\t\t<td>
...
";
        ...
        if (isset($context["forms"])) { $_forms_ = $context["forms"]; } else { $_forms_ = null; }
        if (isset($context["settings"])) { $_settings_ = $context["settings"]; } else { $_settings_ = null; }
        echo $_forms_->gettextField(array("label" => \Craft\Craft::t("URL Prefix "), "instructions" => \Craft\Craft::t("If you have set up a CNAME record pointing to this bucket, you can enter it here. Otherwise leave this setting alone."), "id" => "urlPrefix", "class" => "ltr", "name" => "urlPrefix", "value" => $this->getAttribute($_settings_, "urlPrefix"), "errors" => $this->getAttribute($_settings_, "getErrors", array(0 => "url_prefix"), "method"), "required" => true, "class" => "s3-url-prefix"));
        // line 75
        echo "
...
<input type=\"hidden\" name=\"location\" class=\"s3-bucket-location\" value=\"";
        // line 109
        if (isset($context["settings"])) { $_settings_ = $context["settings"]; } else { $_settings_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_settings_, "location"), "html", null, true);
        echo "\">
";
    }
    ...
    {
        return array (  148 => 109,  145 => 108,  141 => 105,  138 => 104,  134 => 102,  130 => 98,  124 => 94,  114 => 86,  110 => 81,  105 => 78,  103 => 77,  99 => 75,  95 => 65,  91 => 63,  83 => 51,  79 => 48,  76 => 47,  60 => 36,  56 => 29,  49 => 25,  45 => 23,  41 => 15,  37 => 13,  33 => 5,  25 => 2,  19 => 1,  216 => 73,  209 => 68,  206 => 63,  201 => 60,  198 => 59,  177 => 57,  168 => 56,  165 => 55,  158 => 53,  154 => 52,  147 => 50,  140 => 48,  136 => 47,  126 => 52,  119 => 89,  112 => 48,  108 => 47,  100 => 46,  90 => 45,  87 => 53,  82 => 43,  77 => 42,  73 => 40,  68 => 32,  65 => 39,  63 => 30,  59 => 28,  55 => 27,  51 => 26,  47 => 15,  43 => 13,  35 => 12,  30 => 4,  28 => 3,  26 => 5,  24 => 3,);
    }
}
